...
- [Resources on Quora](#resources-on-quora)
- [Resources on Kaggle](#resources-on-kaggle)
- [Cheat Sheets](#cheat-sheets)
- [Classification](#classification)
- [Linear Regression](#linear-regression)
- [Logistic Regression](#logistic-regression)
- [Model Validation using Resampling](#model-validation-using-resampling)
    - [Cross Validation](##cross-validation) 
    - [Bootstraping](##bootstraping)
- [Deep Learning](#deep-learning)
    - [Frameworks](##frameworks)
    - [Feed Forward Networks](##feed-forward-networks)
    - [Recurrent Neural Nets, LSTM, GRU](##recurrent-neural-nets,-lstm,-gru)
    - [Restricted Boltzmann Machine, DBNs](#restricted-boltzmann-machine,-dbns)
    - [Autoencoders](#autoencoders)
    - [Convolution Neural Nets](#convolution-neural-nets)
- [Natural Language Processing](#natural-language-processing)
    - [Topic Modeling, LDA](#topic-modeling)
    - [Word2Vec](#word2vec)
...
- [Other Useful Tutorials](#other-tutorials)
